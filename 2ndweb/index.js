...
function setup() {
    ...
    // image
    loadImage('corgi.jpg', imgCorgi => {
        image(imgCorgi, 0, 0, width, height, 0, 0, imgCorgi.width, imgCorgi.height, CONTAIN);
    });

    loadImage('heart.png', imgHeart => {
        image(imgHeart, 0, 0, width, height, 0, 0, imgHeart.width, imgHeart.height, CONTAIN);
    });
